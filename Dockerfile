...
ENV VITE_API_URL=https://prod-api-dashboard.harx.ai/api
ENV VITE_GOOGLE_API_KEY=AIzaSyCHEKiraViKIrgvloZI-ZBIJqtDMeBuQD0
ENV VITE_BACKEND_URL_COMPANY=https://prod-api-companysearchwizard.harx.ai/api
ENV VITE_BACKEND_URL_GIGS=https://prod-api-gigsmanual.harx.ai/api
ENV TWILIO_ACCOUNT_SID=AC8a453959a6cb01cbbd1c819b00c5782f
ENV VITE_BACKEND_URL_INTEGRATIONS=https://prod-api-dash-integrations.harx.ai/api
...
ENV VITE_BACKEND_KNOWLEDGEBASE_BACKEND=https://prod-api-knowledge-base.harx.ai
